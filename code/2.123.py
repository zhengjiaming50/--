...
keywords = ["按林地保护等级面积统计", "按森林类别面积统计表"]  # 自定义关键词列表
...
prompt_content = (
    ...
    f"1. 以下是参考信息：\n{md_content}\n"
    f"""2. 严格模仿以下格式：③林地保护等级
Ⅲ级林地保护等级面积34.0204hm2，占项目拟使用林地总面积的99.2%；
Ⅳ级林地保护等级面积0.2802hm2，占项目拟使用林地总面积的0.8%。
④森林类别
重点商品林地面积34.0204hm2，占项目拟使用林地总面积的99.2%；
一般商品林地面积0.2802hm2，占项目拟使用林地总面积的0.8%。
...
try:
    ...
    output_file = os.path.join(output_dir,  '2.123.txt')
