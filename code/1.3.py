...
1.拟使用林地的空间位置、面积
根据崇左市扶绥县2018年度森林督查暨森林资源管理一张图成果及外业调查，项目拟使用林地位于崇左市扶绥县龙头乡腾广村6林班94、114、116、118、129、133、134、230、237、246、247、249、250、251、252、253、254、255、257、292小班，涉及1个村1个林班20个小班22个地块。拟使用林地面积34.3006hm²。项目建设使用林地的具体空间位置、面积详见附表A。
2.拟使用林地及林木权属
项目拟长期使用林地面积34.3006hm²，均为集体林地，属扶绥县龙头乡腾广村集体所有；林木面积32.0303hm²，林木权属均为个人。
林地、林木权属清楚、无争议。
3.拟使用林地主要建设内容使用林地情况
...
永久性使用。
5.拟使用林地需要采伐林木情况
项目建设使用林地面积34.3006hm²，涉及林木面积32.0303hm²，蓄积量3405m3，树种为巨尾桉、龙眼。拟使用林地需采伐巨尾桉蓄积量3405m3、龙眼55株。
