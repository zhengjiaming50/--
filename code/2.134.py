...
keywords = ["林地按使用林地类型面积蓄积统计表","使用林地因子调查"]  # 自定义关键词列表
...
prompt_content = (
    ...
    f"1. 以下是参考信息：\n{md_content}\n"
    f"""2. 严格模仿以下格式：④树种组成
巨尾桉面积31.7841hm²，蓄积量3405m3；
龙眼面积0.2462hm²，无蓄积量。
⑤乔木林龄组结构
幼龄林面积1.4984hm²、无蓄积量；
中龄林面积4.4165hm²、蓄积量341m3；
近熟林面积17.9253hm²、蓄积量1895m3；
成熟林面积7.9439hm²、蓄积量1169m3。
⑥经济林资源
经济林面积0.2462hm²，无蓄积量。树种为龙眼，按产期分：均为盛产期。
（二）拟使用林地情况说明
...
try:
    ...
    output_file = os.path.join(output_dir,  '2.134.txt')
