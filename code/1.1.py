...
9.项目拟用地规模
项目拟使用土地总面积37.3421hm²，涉及的林地面积为34.3006hm²，占使用土地总面积的91.9%。
10.项目前期工作开展情况
...
（二）建设布局与拟使用林地的关系
项目总用地面积37.3421hm²，涉及林地面积34.3006hm²。主要建设内容：包含康养文化教育等、公共服务配套、配电、供水、燃气设施和道路等。拟使用林地均用于长乐小镇（包含康养文化教育等、公共服务配套、配电、供水、燃气设施和道路等）建设。
项目位于崇左市扶绥县空港大道王村至扶绥边境段南侧，东至吴圩—那桐高速、南至德古岭、西至王村、北至空港大道，交通便利，地理位置优越，项目建设项目建设有效提高康养文化产业设施及基础设施水平。项目建设用地全过程都坚持集约用地原则，但由于项目用地范围涉及林地，在充分考虑少占、节约使用林地的前提下，项目建设本次使用34.3006hm²的林地面积不可避免。
