...
（一）项目使用林地权属情况说明
经调查，项目拟长期使用林地面积34.3006hm2，均为集体林地。项目建设使用林地权属清楚，不存在纠纷问题。
（二）违法使用林地情况说明
...
（2）项目重叠情况说明
项目与南宁新江经无圩至崇左扶绥一级路（扶绥那列至华阳路口段）改建市政道路工程项目（桂林审政字〔2018〕665号）重叠林地面积0.0170hm2，该部分林地已由上述项目申报并获批，因此不列入本项目使用林地范围统计。
